#!/bin/bash
printf "\e[0;32;40m"
echo -e "臺北市自由軟體推動小組 fosstp -- 自動化 Drupal 校園網站自動安裝程序\n"
printf "\e[0m"
echo " ========================================================"
...
echo " ========================================================"
printf "\e[0;33;40m"
read -p "請輸入您要使用的 mysql root 密碼(Please enter your mysql root password): " mysql_pw

read -p "您是否要安裝 phpmyadmin (Do you want to install phpmyadmin) Y/N: " pma_yn

read -p "請輸入您要使用的 drupal 站台名稱(Please enter your drupal site-name): "  drupal_sitename

read -p "請輸入您要使用的 drupal 管理員密碼(Please enter your drupal admin password): "  drupal_admin_pw
printf "\e[0m"
echo " ========================================================"
echo -e "偵測系統版本....."
...
printf "\e[0;35;40m"
echo -e "系統版本為: " $DISTRO " 開始進行 docker 安裝"
printf "\e[0m"
echo " ========================================================"

case ${DISTRO} in
  "RedHat")
	echo -e "於 RedHat / CentOS 系統底下 安裝 docker \n\n"
	...
	chkconfig docker on
        ;;
  "Debian")
        echo -e "於 Debian / Ubuntu 系統底下 安裝 docker \n\n"
...
if [ "${pma_yn}" == "Y" ] || [ "${pma_yn}" == "y" ]; then
	printf "\e[0;35;40m"
	echo -n "開始進行 phpmyadmin docker 部署動作...."
	printf "\e[0m"
...
printf "\e[0;35;40m"
echo -n "開始進行 drupal docker 部署動作...."
printf "\e[0m"
...
echo " ========================================================"
printf "\e[0;32;40m"
echo -e "安裝結束 您可以使用下列網址測試 drupal 是否安裝成功 系統管理員帳號為 admin 密碼為"  $drupal_admin_pw "\n"
hostname -I | awk '{ print "http://"$1"/"}'

if [ "${pma_yn}" == "Y" ] || [ "${pma_yn}" == "y" ]; then
        echo -e "\n您可以使用下列網址測試 phpmyadmin 是否安裝成功 phpmyadmin帳號為 root 密碼為"  $mysql_pw  "\n"
